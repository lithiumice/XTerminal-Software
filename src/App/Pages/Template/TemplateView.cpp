...
void TemplateView::weather_style_init(void)
{
...
void TemplateView::weather_gui_init(lv_obj_t* root)
{
...
//data
void TemplateView::SetCityName(const char* cityName)
{
	lv_label_set_text(
		ui.cityLabel,
		cityName
...
void TemplateView::SetTemperatue(const int temperatue)
{
	lv_bar_set_value(
		ui.tempBar,
		temperatue,
...
void TemplateView::SetHuminature(const int huminature)
{
...
//info
void TemplateView::SetTextInfo(const int minTemp, const int maxTemp, const char* windDir, const int windLevel)
{
	lv_label_set_text_fmt(
		ui.txtLabel,
...
//time 
void TemplateView::SetClockDay(const int month, const int day)
{
...
void TemplateView::SetClockHour(const int hour, const int min)
{
	lv_label_set_text_fmt(
		ui.clockLabel_1,
		"%02d : #ffa500 %02d#",
...
void TemplateView::SetClockSec(const int sec)
{
