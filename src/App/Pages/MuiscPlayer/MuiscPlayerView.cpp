...
void MuiscPlayerView::Create(lv_obj_t *root)
{
...
void MuiscPlayerView::Group_Init()
{
...
void MuiscPlayerView::Delete()
{
	lv_group_del(ui.group);
	Style_Reset();
}

void MuiscPlayerView::SetScrollToY(lv_obj_t *obj, lv_coord_t y, lv_anim_enable_t en)
{
...
void MuiscPlayerView::onFocus(lv_group_t *g)
{
...
void MuiscPlayerView::Style_Init()
{
...
void MuiscPlayerView::Style_Reset()
{
...
void MuiscPlayerView::Item_Create(
	item_t *item,
	lv_obj_t *par,
	const char *name,
	const char *img_src,
